...
BOOL logopen(FILE_SYS_INFO *sysinfo)
{
...
Removable=%d, Present=%d, Logicalpart=%d, Readonly=%d, lastblock=%x\n",
	  		i,
...
Removable=%d, Present=%d, IoAlign=%d, Logicalpart=%d, Readonly=%d, lastblock=%x name:%s\n",
	  		g_disknum,
	  		HandleBuffer[i] ,BlkIo,Status,Media->BlockSize,\
            Media->RemovableMedia,
            Media->MediaPresent,
